        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex items-center gap-8">
                    ...
                    <a href="${pageContext.request.contextPath}/propiedades" class="text-sm font-semibold text-blue-600 transition-colors">Catálogo</a>
    ...
    <main class="flex-grow pt-28 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-end mb-10 gap-4">
                 <div>
                     <h2 class="text-3xl font-extrabold tracking-tight text-slate-900">Propiedades Destacadas</h2>
                     <p class="text-slate-500 mt-2">Encuentra casas, departamentos y terrenos al mejor precio.</p>
                 </div>
                 <a href="${pageContext.request.contextPath}/propiedades?accion=nuevo" class="inline-flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg shadow-indigo-600/20 transition-all hover:-translate-y-1">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="mt-2 text-amber-700">
                                    <p>Actualmente no hay propiedades agregadas o no se pudo conectar a la base de datos MySQL.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <c:forEach var="propiedad" items="${listaPropiedades}">
                            ...
                            <div class="group bg-white rounded-2xl shadow-sm hover:shadow-xl border border-slate-200 overflow-hidden transition-all duration-300 hover:-translate-y-1 flex flex-col">
                                <div class="relative h-56 bg-slate-200 overflow-hidden">
                                    ...
                                    <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Propiedad" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                                    <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-indigo-600 shadow-sm">
                                        En Venta
                                    </div>
                                </div>
                                <div class="p-6 flex-grow flex flex-col">
                                    <div class="flex items-baseline gap-2 mb-2">
                                        <h3 class="text-2xl font-bold text-slate-900 line-clamp-1"><c:out value="${propiedad.titulo}" /></h3>
                                    </div>
                                    <div class="flex items-center text-slate-500 text-sm mb-4">
                                        ...
                                        <span class="truncate"><c:out value="${propiedad.ubicacion}" /></span>
                                    </div>
                                    <p class="text-slate-600 text-sm mb-6 line-clamp-3 flex-grow"><c:out value="${propiedad.descripcion}" /></p>
                                    <div class="pt-4 border-t border-slate-100 flex justify-between items-center mt-auto">
                                        <div class="text-emerald-600 font-extrabold text-xl">
                                            US$ <c:out value="${propiedad.precio}" />
                                        </div>
                                        <button class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 transition-colors">Ver detalles &rarr;</button>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
