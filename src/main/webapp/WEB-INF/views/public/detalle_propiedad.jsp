                        ...
                        <c:when test="${not empty sessionScope.usuarioLogueado}">
                            <c:choose>
                                <c:when test="${propiedad.favorito}">
                                    <form action="${pageContext.request.contextPath}/favorito" method="POST" class="inline m-0 p-0">
                                        <input type="hidden" name="accion" value="remover">
                                        <input type="hidden" name="id" value="${propiedad.id}">
                                        <button type="submit" class="flex items-center gap-1.5 text-red-500 hover:text-red-600 transition-colors bg-transparent border-0 cursor-pointer p-0 font-semibold text-sm" title="Quitar de favoritos">
                                ...
                                <c:otherwise>
                                    <form action="${pageContext.request.contextPath}/favorito" method="POST" class="inline m-0 p-0">
                                        ...
                                        <input type="hidden" name="id" value="${propiedad.id}">
                                        <button type="submit" class="flex items-center gap-1.5 hover:text-black text-slate-500 transition-colors bg-transparent border-0 cursor-pointer p-0 font-semibold text-sm" title="Guardar en favoritos">
