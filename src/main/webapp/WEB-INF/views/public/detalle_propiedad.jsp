            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-xl border border-slate-100 space-y-6">
                        ...
                        <h1 class="text-3xl md:text-4xl font-black text-slate-900 tracking-tight leading-tight">${propiedad.titulo}</h1>
                        ...
                        <p class="text-slate-600 flex items-center gap-2 text-base">
                            ...
                            <span>${propiedad.direccion}, ${propiedad.distrito}, ${propiedad.provincia}</span>
                        </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-xl border border-slate-100 flex flex-col">
                            ...
                            <div class="text-slate-600 text-sm leading-relaxed whitespace-pre-wrap flex-grow">${propiedad.descripcion}</div>
                        </div>
